...
/**
 * Reserve project names that should not be allowed as machine/short names.
 *
 * @return array
 *   Strings which should be reserved, all lowercase.
 */
function hook_project_reserved_names() {
  return [
    'preview',
    'blame',
    'blob',
